# Upgrade Progress
  ...
  - ###
    ...
    - Upgrade Java from 8 to 21
      - Updated java.version, maven.compiler.source, and maven.compiler.target properties
    - Migrate javax.* to jakarta.* namespace
      - Updated javax.persistence to jakarta.persistence imports
      - Updated javax.validation to jakarta.validation imports
    - Apply Java 21 code improvements
      - Changed !Optional.isPresent() to Optional.isEmpty()
      - Changed List.get(0) to List.getFirst()
      - Updated String.format() to String.formatted()
      - Removed unnecessary @RequestParam value attribute
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.3.13 to 3.4.2
      - Updated spring-boot-starter-parent version in pom.xml
    </details>
