# Upgrade Progress
  ...
  - ###
    ...
    - Migrate javax.* packages to jakarta.* namespace
      ...
      - Changed javax.validation.* to jakarta.validation.* in Photo.java
    - Apply Spring Boot 3.3 specific changes
      - Removed explicit @RequestParam("files") name in HomeController.java
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot from 3.3.13 to 3.4.2
      - Updated spring-boot-starter-parent version in pom.xml to 3.4.2
    </details>
