# Upgrade Progress
  ...
  - ###
    ...
    - Upgrade Spring Boot to 3.3.13
      - Updated parent POM version from 2.7.18 to 3.3.13
    - Migrate javax.* to jakarta.* namespace
      - Updated Photo.java: javax.persistence.* → jakarta.persistence.*, javax.validation.* → jakarta.validation.*
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot to 3.4.5
      - Updated parent POM version from 3.3.13 to 3.4.5
    </details>
