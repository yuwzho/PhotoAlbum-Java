# Upgrade Progress
  ...
  - ###
    ...
    - Upgrade Java from 8 to 21
      - Updated `java.version`, `maven.compiler.source`, `maven.compiler.target` properties in pom.xml
    - Migrate javax.* to jakarta.* namespace
      - Updated imports in Photo.java from javax.persistence and javax.validation to jakarta.persistence and jakarta.validation
