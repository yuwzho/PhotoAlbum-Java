# Upgrade Progress
  ...
  - ###
    ...
    - Upgrade Java from 8 to 21
      - Updated java.version, maven.compiler.source, maven.compiler.target in pom.xml
    - Migrate javax.* to jakarta.* namespace
      - Changed javax.persistence.* to jakarta.persistence.* in Photo.java
      - Changed javax.validation.constraints.* to jakarta.validation.constraints.* in Photo.java
    - Modernize code for Java 21
      ...
      - Removed redundant @RequestParam value in HomeController
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot from 3.3.13 to 3.4.7
      - Updated parent version in pom.xml from 3.3.13 to 3.4.7
    </details>
