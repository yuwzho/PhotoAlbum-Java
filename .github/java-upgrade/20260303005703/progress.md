# Upgrade Progress
  ...
  - ###
    ...
    - Upgrade Java version from 8 to 21
      - Updated `java.version` property from `1.8` to `21` in pom.xml
      - Updated `maven.compiler.source` from `8` to `21` in pom.xml
      - Updated `maven.compiler.target` from `8` to `21` in pom.xml
    </details>
