# Upgrade Progress
  ...
  - ###
    ...
    - Upgrade Spring Boot from 2.7.18 to 3.3.13
      - Updated `spring-boot-starter-parent` version in pom.xml to 3.3.13
    - Upgrade Java from 8 to 21
      - Updated `java.version`, `maven.compiler.source`, and `maven.compiler.target` to 21 in pom.xml
    - Migrate javax.* to jakarta.* namespaces
      - Updated `Photo.java` imports from `javax.persistence.*` and `javax.validation.constraints.*` to `jakarta.persistence.*` and `jakarta.validation.constraints.*`
    - Modernize Java API usage
      - Replaced `!Optional.isPresent()` with `Optional.isEmpty()` in DetailController, PhotoFileController, PhotoServiceImpl
      ...
      - Removed explicit `value` attribute from `@RequestParam("files")` in HomeController
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot from 3.3.13 to 3.4.7
      - Updated `spring-boot-starter-parent` version in pom.xml from 3.3.13 to 3.4.7
    </details>
  ...
  - ###
    ...
    #### Checked Dependencies
      - org.springframework.boot:spring-boot-starter-web:3.4.7:jar
      - org.springframework.boot:spring-boot-starter-thymeleaf:3.4.7:jar
      - org.springframework.boot:spring-boot-starter-data-jpa:3.4.7:jar
      - com.oracle.database.jdbc:ojdbc8:23.5.0.24.07:jar
      - org.springframework.boot:spring-boot-starter-validation:3.4.7:jar
      - org.springframework.boot:spring-boot-starter-json:3.4.7:jar
      - org.springframework.boot:spring-boot-starter-test:3.4.7:jar
      - com.h2database:h2:2.3.232:jar
      - org.springframework.boot:spring-boot-devtools:3.4.7:jar
      - java:*:21
    </details>
